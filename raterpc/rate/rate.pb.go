...
func (m *SDGRate) Reset()         { *m = SDGRate{} }
...
func (m *SDGRate) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SDGRate.Unmarshal(m, b)
}
func (m *SDGRate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SDGRate.Marshal(b, m, deterministic)
}
func (m *SDGRate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SDGRate.Merge(m, src)
}
func (m *SDGRate) XXX_Size() int {
	return xxx_messageInfo_SDGRate.Size(m)
}
func (m *SDGRate) XXX_DiscardUnknown() {
	xxx_messageInfo_SDGRate.DiscardUnknown(m)
}

var xxx_messageInfo_SDGRate proto.InternalMessageInfo

func (m *SDGRate) GetMessage() float32 {
	if m != nil {
		return m.Message
	}
	return 0
...
// RaterClient is the client API for Rater service.
//
...
func NewRaterClient(cc *grpc.ClientConn) RaterClient {
	return &raterClient{cc}
}

func (c *raterClient) GetSDGRate(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SDGRate, error) {
	out := new(SDGRate)
	err := c.cc.Invoke(ctx, "/raterpc.Rater/GetSDGRate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UnimplementedRaterServer struct {
}
...
func RegisterRaterServer(s *grpc.Server, srv RaterServer) {
	s.RegisterService(&_Rater_serviceDesc, srv)
}

func _Rater_GetSDGRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaterServer).GetSDGRate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/raterpc.Rater/GetSDGRate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaterServer).GetSDGRate(ctx, req.(*Empty))
	}
